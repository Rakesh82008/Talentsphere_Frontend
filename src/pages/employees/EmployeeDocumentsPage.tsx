...
export default function EmployeeDocumentsPage() {
  ...
  const [empId, setEmpId] = useState<number | null>(id ? parseInt(id) : null)
  ...
  const load = async (resolvedEmpId: number) => {
    setLoading(true)
    try {
  ...
  const onVerify = async (docId: number, status: 'Verified' | 'Rejected') => {
