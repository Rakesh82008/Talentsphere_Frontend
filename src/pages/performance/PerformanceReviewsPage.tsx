...
import type { PerformanceReviewResponse, CreatePerformanceReviewDTO, EmployeeResponse } from '../../types'
...
type ReviewForm = { employeeID: string; reviewDate: string; rating: string; comments: string }
...
export default function PerformanceReviewsPage() {
  ...
  const [editReview, setEditReview] = useState<PerformanceReviewResponse | null>(null)
  ...
  const onSubmit = async (data: ReviewForm) => {
    setSaving(true)
    try {
      const payload: CreatePerformanceReviewDTO = { employeeID: parseInt(data.employeeID), reviewDate: data.reviewDate, rating: parseInt(data.rating), comments: data.comments }
      if (editReview) {
