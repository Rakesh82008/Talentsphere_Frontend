...
export default function MyApplicationsPage() {
  ...
  const fetchPipeline = async (appId) => {
    ...
    return {
      ...
      interviews: iv.status === 'fulfilled' ? (Array.isArray(iv.value) ? iv.value : [iv.value]) : [],
