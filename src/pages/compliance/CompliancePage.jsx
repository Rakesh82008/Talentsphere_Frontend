...
export default function CompliancePage() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      if (editRecord) {
        await complianceApi.update(editRecord.complianceID, { employeeID: parseInt(data.employeeID), recordType: data.recordType, description: data.description })
        toast.success('Record updated')
        setEditRecord(null)
      } else {
        await complianceApi.create({ employeeID: parseInt(data.employeeID), recordType: data.recordType, description: data.description })
