...
import type { EnrollmentResponse, TrainingResponse, EmployeeResponse } from '../../types'
...
type EForm = { employeeID: string; trainingID: string }
type CForm = { score: string; notes: string; certificateUrl: string }
...
export default function EnrollmentsPage() {
  ...
  const enrollForm = useForm<EForm>()
  const completeForm = useForm<CForm>()
  ...
  const onEnroll = async (data: EForm) => {
    setSaving(true)
    try {
  ...
  const onComplete = async (data: CForm) => {
