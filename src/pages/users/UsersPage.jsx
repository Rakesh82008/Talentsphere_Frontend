...
export default function UsersPage() {
  ...
  const { register: regRole, handleSubmit: handleRoleSubmit, reset: resetRole, formState: { errors: errorsRole } } = useForm()
  ...
  const onUpdateUser = async (data) => {
    ...
    setSaving(true)
    try {
      await usersApi.update(editUser.userID, { ...data, status: data.status })
